        ...
        <>
            ...
            <main className="min-h-screen bg-gray-50 pt-20 pb-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm overflow-hidden lg:flex gap-8 p-6 lg:p-8">
                        {/* Image Section */}
                        <div className="lg:w-1/2">
                            ...
                            <div className="bg-gray-50 rounded-xl relative aspect-square overflow-hidden group">
                                ...
                                />
                                {discount > 0 && (
                                    <div className="absolute top-4 left-4 bg-red-500/80 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-sm font-bold shadow-lg">
                                        {discount}% OFF
                                    </div>
                                )}
                            </div>
                            ...
                            {product.rating && (
                                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                                    <div className="flex items-center gap-2">
                                        <div className="flex items-center bg-green-600 text-white px-2.5 py-1 rounded-lg text-sm font-bold">
                                            {product.rating} ★
                                        </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <button
                                        ...
                                        className="flex-1 bg-primary text-white rounded-lg py-3.5 px-6 text-base font-bold hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary shadow-md hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                ...
                                {/* Wishlist Button */}
                                <button className="w-full flex items-center justify-center gap-2 py-3 border-2 border-gray-200 rounded-lg text-gray-700 font-semibold hover:border-red-300 hover:text-red-500 hover:bg-red-50 transition-all">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    >
                                        ...
                                        <div className="relative aspect-square bg-gray-50 overflow-hidden">
                                            ...
                                            {relatedProduct.discountPercentage && relatedProduct.discountPercentage > 0 && (
                                                <div className="absolute top-2 left-2 bg-red-500/80 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded-full">
