            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl relative z-10 border border-gray-100">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        Join Shopomatix for the best shopping experience
                    </p>
                </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="appearance-none rounded-lg relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    pattern="[0-9]{10}"
                                    className="appearance-none rounded-lg relative block w-full pl-10 pr-4 py-3 border border-gray-300 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
