            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-10">
                <p className="text-gray-700 leading-relaxed mb-4">
                  At Shopomatix, operated by Nexfora Solutions Pvt Ltd, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  To exercise these rights, please contact us at support@shopomatix.com.
                </p>
              </div>
