        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-10">
                <h2 className="text-2xl font-bold text-dark mb-4">2. Order Cancellation by Shopomatix</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Shopomatix does not charge any cancellation fees for orders cancelled before dispatch. However, excessive cancellations may result in account restrictions or suspension.
                </p>
              </div>
