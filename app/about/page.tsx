                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="w-full md:w-1/2">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-6">
                                At Shopomatix, we believe in the power of technology to connect people with the products they love.
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed mb-8">
                                ...
                                lightning-fast delivery network, every aspect of Shopomatix is designed with you in mind.
                            </p>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={idx} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                ...
                <section className="py-20 px-4 text-center">
                    <div className="max-w-4xl mx-auto bg-gradient-to-r from-dark to-gray-800 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-300 text-lg mb-8 max-w-xl mx-auto">Join thousands of satisfied customers and experience the Shopomatix difference today.</p>
                            <Link href="/shop" className="inline-block bg-primary text-white font-bold py-4 px-10 rounded-full hover:bg-white hover:text-primary transition-all duration-300 transform hover:-translate-y-1 shadow-lg">
                                Explore Products
                            </Link>
                        </div>
                        {/* Decorative circles */}
