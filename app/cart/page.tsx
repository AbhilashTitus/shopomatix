        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 pt-12 pb-24 px-4 sm:px-6 lg:px-8">
                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start">
                    ...
                    {/* Order Summary */}
                    <div className="mt-16 bg-white rounded-xl shadow-sm p-6 lg:mt-0 lg:col-span-4 lg:sticky lg:top-24">
                        <h2 className="text-lg font-medium text-gray-900 mb-6">Order Summary</h2>

                        <dl className="space-y-4">
                            <div className="flex items-center justify-between">
                                <dt className="text-sm text-gray-600">Subtotal ({items.reduce((acc, item) => acc + item.quantity, 0)} items)</dt>
                                <dd className="text-sm font-medium text-gray-900">₹{cartTotal.toLocaleString('en-IN')}</dd>
                            </div>
