            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-10">
                <p className="text-gray-700 leading-relaxed mb-4">
                  At Shopomatix, we are committed to delivering your orders safely and on time. This policy outlines our shipping and delivery procedures.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Currently, Shopomatix only ships within India. We do not offer international shipping at this time. We are working to expand our services globally in the future.
                </p>
              </div>
