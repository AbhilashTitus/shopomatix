          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Shopomatix is committed to delivering your orders in a timely and secure manner. We work with trusted logistics partners across India to ensure your products reach you safely. All delivery timelines mentioned are estimates and may vary based on factors beyond our control.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Shopomatix shall not be liable for delays or non-delivery due to circumstances beyond our reasonable control, including but not limited to:
                </p>
                <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 space-y-2 ml-4">
