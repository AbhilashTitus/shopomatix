            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-10">
                <p className="text-gray-700 leading-relaxed mb-4">
                  At Shopomatix, we want you to be completely satisfied with your purchase. This Refund Policy outlines the conditions and procedures for returns and refunds on our platform.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 space-y-2 ml-4">
                  ...
                  <li>Contacting our customer support at support@shopomatix.com</li>
