          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-10">
                ...
                <h3 className="text-xl font-semibold text-dark mb-3 mt-6">4.2 Shopomatix Response</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 space-y-2 ml-4">
                  ...
                  <li><strong>In favor of merchant:</strong> Chargeback is reversed, funds returned to Shopomatix</li>
                </ul>
              </div>
              ...
              <div className="mb-10">
                ...
                <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 space-y-2 ml-4">
                  ...
                  <li><strong>Platform Issues:</strong> Shopomatix is responsible for chargebacks due to payment processing errors or technical glitches</li>
