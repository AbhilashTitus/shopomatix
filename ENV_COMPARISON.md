...
```bash
ubuntu@ip-172-31-11-54:~/shopomatix$ cat .env.local
...
### Your File (Broken)
```
Line 1: NEXT_PUBLIC_RAZORPAY_KEY_ID=rzp_test_Rjvg7mjDAAKe1RRAZORPAY_KEY_SECRET=2KH3YutLCT2DW4AcHdvhXyg7EKYC_API_USERNAME=7676717667EKYC_API_TOKEN=5cbf9f97ff8cd6ab1f1d48ce95a7adf9
```
...
Line 4: EKYC_API_USERNAME=7676717667
