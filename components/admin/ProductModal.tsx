          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  className={`image-drop-area border-2 border-dashed rounded-lg p-6 text-center transition-colors ${
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-primary resize-vertical"
