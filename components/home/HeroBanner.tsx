      ...
      <div className="relative h-full flex items-center justify-center px-6">
        <div className="bg-black/30 backdrop-blur-md rounded-3xl px-12 py-16 text-center max-w-2xl w-full mx-auto border border-white/10 shadow-2xl">
          ...
          {!user && (
            <Link
              href={ctaLink}
              className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white text-[16px] font-semibold rounded-full hover:bg-secondary transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              {ctaText}
            </Link>
          )}
